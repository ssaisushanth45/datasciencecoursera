...
Salary categories (L -0.57m, M-1.09m, H-4.32m, UH-34.42m)
```{r ,cache = TRUE, eval= TRUE, results='asis', fig.align='center', message=FALSE, fig.height=4.5, fig.width=7}
...
qplot(salarymm, data = plotting_data_frame, facets =.~league, 
      xlab= "Salary in Millions", ylab = "# Players", 
      main = "Salary Comparisons IPL vs. US Major Leagues", fill = Salcat, bins = 50)
```
